...
/// Private witness assignment for an R1CS instance.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct R1csWitness<R: Ring, N = WitnessNorms> {
...
impl<R: Ring, N: WitnessNormMetadata<R>> R1csWitness<R, N> {
...
impl<R: Ring + CanonicalSerialize, N: CanonicalSerialize> CanonicalSerialize for R1csWitness<R, N> {
...
impl<R: Ring + Valid, N: WitnessNormMetadata<R>> Valid for R1csWitness<R, N> {
